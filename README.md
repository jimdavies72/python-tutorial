# Repo: python-tutorial
![Static Badge](https://img.shields.io/badge/Dev_status-Complete-blue)

## Reason: To understand the basics of Python Development

### Description

This repo represents the work I undertook as a result of a short online 'introduction to Python' course that I did as part of a job application process. Its a bit of a mixed bag of stuff and I have tried to explain what there is here:
